...
<html>
    <head>
        ...
        <style>
            ...
            .month-input { display: flex; align-items: center; margin-bottom: 10px; }
            .month-input label { flex: 1; margin-bottom: 0; }
            .month-input input { flex: 2; margin-bottom: 0; }
    ...
    <body>
        <div class="container">
            <h1>Calculadora de Consumo de Energia da Lavadora</h1>
            <%
            ...
            <form action="ConsumoServlet" method="post">
                ...
                <div class="month-input">
                    ...
                    <input type="number" id="month<%= i + 1%>" name="month<%= i + 1%>" min="0" step="0.01" required>
                </div>
                <%
                    }
                %>
